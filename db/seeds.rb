...
users = [{
    name: 'admin',
    email: 'admin@gmail.com(opens in new tab)',
    password: 'password'
  },  
  {
    name: 'user_1',
    email: 'user_1@gmail.com(opens in new tab)',
    password: 'password'
  },
  {
    name: 'user_2',
    email: 'user_2@gmail.com(opens in new tab)',
    password: 'password'
  }
]
users.each do |user|
...
# Gear 
puts "Seeding Gears"
gears = ['water bottle', 'sleeping bag', 'compass', 'mat', 'travel pillow', 'backpack', 'tent', 'swiss army knife', 'water treatment tablets', 'watch', 'raincover', 'walking poles']
gears.each do |gear|
  Gear.create(
    name: gear
  )
